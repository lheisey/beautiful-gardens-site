...
(new WOW).init(),$(window).scroll(function(){10<$(this).scrollTop()?$(".navbar-fixed-top").removeClass("head-room"):$(".navbar-fixed-top").addClass("head-room")});var btn=$("#back-top");$(window).scroll(function(){250<$(window).scrollTop()?btn.addClass("showbtn"):btn.removeClass("showbtn")}),btn.on("click",function(o){o.preventDefault(),$("html, body").animate({scrollTop:0},"500","linear")});